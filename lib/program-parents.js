...
if (program.child) {
  ...
  Saver.finish(outputDir, 'Would you like to save the mother? (y | n)', parents.motherDNA, () => {
    Renderer.output(parents.fatherDNA);
    Saver.finish(outputDir, 'Would you like to save the father? (y | n)', parents.fatherDNA);
  });
}
